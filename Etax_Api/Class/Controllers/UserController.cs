...
namespace Etax_Api.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public UserController(ApplicationDbContext context, IConfiguration config, IExceptionLogger exceptionLogger, IJwtService jwtService)
        {
            _config = config;
            _context = context;
        ...
        public async Task<IActionResult> GetUserTabel([FromBody] BodyDtParameters bodyDtParameters)
        {
            try
            {
                ...
                var permission = await (from up in _context.user_permission
                                        ...
                                        select up.per_user_menu).FirstOrDefaultAsync();
